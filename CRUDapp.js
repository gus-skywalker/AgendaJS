    ...
    this.Add = function () {
      ...
      this.Edit = function (item) {
        ...
        document.getElementById('saveEdit').onsubmit = function() {
          ...
          if (Array.isArray(self.contatos[item])) {
            console.log('Contatos é uma Array');
          } else {
            console.log('Contatos NÃO é uma Array !!');
          };
          // if (novo_nome && novo_telefone && novo_email != null && Array.isArray(self.contatos)) {
          //   // Edita os novos valores
          //   this.contatos.splice(item, 1, novo_contato);
          //   // Mostra a nova lista
          //   self.FetchAll();
          //   // Esconde o campo
          //   CloseInput();
